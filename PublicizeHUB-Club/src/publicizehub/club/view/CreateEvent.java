    ...
    public void newEvent() {
        ...
        try {
            ...
            String sql = "INSERT INTO tb_event"
                    + "(evId,evName,evDescrip,evDate,evPlace,evTicket,evTime) "
                    + "VALUES ('" + evId.getText() + "','"
                    + evName.getText()+ "','"
                    + evDescrip.getText()+ "','"
                    + evDate.getText()+ "','"
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(evTime, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
